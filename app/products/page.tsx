      ...
      <section className="rounded-soft border border-line bg-surface px-4 py-4 md:px-5 md:py-5">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex w-full flex-wrap items-center gap-2 md:w-auto md:flex-nowrap">
            <div className="relative min-w-[210px] flex-1 md:w-[240px] md:flex-none">
            ...
            <Select className="h-9 w-[138px] bg-surface text-[13px]">
            ...
            <Select className="h-9 w-[112px] bg-surface text-[13px]">
              <option>ترتيب</option>
